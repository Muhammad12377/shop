    ...
    <div>
      ...
      <div className="md:hidden space-y-3">
        {coupons.length === 0 ? (
          ...
          coupons.map((coupon) => (
            <div key={coupon.id} className="bg-white rounded-xl border border-zinc-200 p-4">
              ...
              <div className="grid grid-cols-2 gap-y-1.5 text-xs text-zinc-500 mb-3">
                <span>
                  {isRtl ? "النوع:" : "Type:"}{" "}
                  <span className="text-zinc-700">
                    {coupon.discount_type === "percentage"
                      ? isRtl ? "نسبة مئوية" : "Percentage"
                      : isRtl ? "قيمة ثابتة" : "Fixed"}
                  </span>
                </span>
                <span>
                  {isRtl ? "القيمة:" : "Value:"}{" "}
                ...
                <span>
                  {isRtl ? "أقل طلب:" : "Min Order:"}{" "}
                  <span className="text-zinc-700">${coupon.min_order?.toFixed(2)}</span>
                </span>
                <span>
                  {isRtl ? "الاستخدام:" : "Used:"}{" "}
                  <span className="text-zinc-700">{coupon.used_count || 0}/{coupon.max_uses || "∞"}</span>
                </span>
