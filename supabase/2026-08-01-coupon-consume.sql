-- ============================================================
-- Coupon consumption 2026-08-01
-- Coupons are NOT consumed at order creation.
-- They are consumed only when an order reaches a "stocked"
-- state (confirmed / shipped / delivered), mirroring the
-- product-stock behaviour. Consumption is handled by the
-- admin status route (src/app/api/admin/orders/[id]/status).
-- ============================================================
